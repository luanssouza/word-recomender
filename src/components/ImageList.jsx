    ...
    try{
        const films = props.films.map(({ imdbID, Poster, Title, Year }) => {
            ...
            return  <div className="card"  key={imdbID} >
                        ...
                        <button type="button" className="btn btn-lg btn-primary btn-like" onClick={() => props.handler(Title)}>
                            <div className="inline">
                                <svg viewBox="0 0 16 16" className="bi bi-hand-thumbs-up like-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
